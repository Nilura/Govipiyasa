...
class expertView extends StatefulWidget {
  ...
  expertView({this.designation,this.description,this.city , this.contact,this.name,this.qualification,this.list ,this.rating,this.docs,this.slots,this.image});
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                return Card(
                                  child: ListTile(
                                      ...
                                      trailing:Text(widget.list[index]['review'].toString(),
                                        style: TextStyle(color: Colors.green, fontSize: 15),
                                      ),
                                      title: Text(widget.list[index]['user'].toString())),
                                );
                              }),),
                        Center(
